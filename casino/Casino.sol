...
contract Casino is ICasino {
    ...
    /// true = 19 - 36
    /// false = 1 - 18
    function greatSmallBet(uint8 isGreat) public view override {
        ...
        bool hasWon = false;
        if (rouletteNumber != 0)
            hasWon = ((rouletteNumber >= 19) == isGreatBool);
        finishBet(hasWon,
            bet * payoutMultiplier,
            rouletteNumber,
            minBalance);
    ...
    /// true = even numbers
    /// false = odd numbers
    function parityBet(uint8 isEven) public view override {
        ...
        bool hasWon = false;
        if (rouletteNumber != 0)
            hasWon = (((rouletteNumber % 2) == 1) == !isEvenBool);
        finishBet(hasWon,
            bet * payoutMultiplier,
            rouletteNumber,
            minBalance);
    ...
    /// true = red numbers
    /// false = black numbers
    function colorBet(uint8 isRed) public view override {
        ...
        if (rouletteNumber != 0) {
            ...
            (rouletteNumber >= 19 && rouletteNumber <= 28)) {
                hasWon = ((rouletteNumber % 2) == 1) == isRedBool;
            } else {
                hasWon = ((rouletteNumber % 2) == 1) != isRedBool;
            }
        }
